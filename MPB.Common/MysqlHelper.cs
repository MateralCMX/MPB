...
namespace MPB.Common
{
    public class MysqlHelper
    {
        ...
        public MysqlHelper(string address, string dbName, string account, string password, int port)
        {
            _connectionString = string.Format("server={0};user id={1};password={2};persistsecurityinfo=True;port={3};database={4};SslMode=none", address, account, password, port, dbName);
        }
