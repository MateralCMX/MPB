    ...
    public class SqlServerDAL
    {
        ...
        public List<SqlServerTableModel> GetUserCreateTableInfo()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                List<SqlServerTableModel> listM = dt.MToList<SqlServerTableModel>(true);
                return listM;
            }
            else
            {
